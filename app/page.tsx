...
//     console.log(data); // Will contain the Instagram profile details
//   } catch (error) {
...
//           <img src={profileData.profile_pic_url} alt="profile" width="100" />
//         </div>
//       )}
//     </div>
//   );
...
import InstagramSearch from '@/app/components/InstragramSearch';
